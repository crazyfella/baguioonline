...
<head>
    ...
    <?php echo $__env->yieldContent('fbMetaTags'); ?>
                                ...
                                <div class="category-toggle-wrap">
                                    ...
                                    <nav class="category-menu category-style-2">
                                        ...
                                        <ul>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'automative-motorcycles'])); ?>"><i class="fa fa-car"></i> Automotive & Motorcycles</a>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'sports-lifestyle'])); ?>"><i class="fa fa-futbol-o"></i> Sports & Lifestyle</a>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'fashions'])); ?>"><i class="fa fa-shopping-bag"></i> Fashion</a>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'home-living'])); ?>"><i class="fa fa-bed"></i> Home and Living</a>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'foods-groceries'])); ?>"><i class="fa fa-cutlery"></i> Foods & Groceries</a>
                                                ...
                                                <ul class="category-mega-menu">
                                                    ...
                                                    <?php $__currentLoopData = $foods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'pets'])); ?>"><i class="fa fa-paw"></i> Pets & Accessories</a>
                                                ...
                                                <ul class="category-mega-menu">
                                                    ...
                                                    <?php $__currentLoopData = $pets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'babies-toys'])); ?>"><i class="fa fa-child"></i> Babies & Toys</a>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'health-beauty'])); ?>"><i class="fa fa-medkit"></i> Health & Beauty</a>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'tv-home-appliances'])); ?>"><i class="fa fa-television"></i> TV & Home Appliances</a>
                                            ...
                                            <li class="menu-item-has-children"><a href="<?php echo e(route('category-products', ['category'=>'electronic-devices'])); ?>"><i class="fa fa-mobile"></i> Electronic Devices</a>
                ...
                <div class="container">
                    ...
                    <div class="footer-bottom-wrap">
                        ...
                        <div class="copyright-text">
                            ...
                            <p><a href="baguioonline.com">Baguio Online © <?php echo e(now()->year); ?></a></p>
...
<?php /**PATH /home/customer/www/baguioonline.com/public_html/resources/views/layouts/master.blade.php ENDPATH**/ ?>