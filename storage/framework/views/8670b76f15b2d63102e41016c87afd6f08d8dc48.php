...
<?php $__env->startSection('fbMetaTags'); ?>
    <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <meta property="og:url"           content="https://www.baguioonline.com/product-details?details=<?php echo e($meta->productSlug); ?>" />
        <meta property="og:type"          content="article" />
        <meta property="og:title"         content="<?php echo e($meta->productName); ?>" />
        <meta property="og:description"   content="<?php echo e(strip_tags($meta->productDescription)); ?>" />
        <meta property="fb:app_id"        content="169994830983601"/>
        <meta property="og:image"     content="<?php echo e(asset('images/featured/'.$meta->photo)); ?>" />
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/baguioonline.com/public_html/resources/views/product-details.blade.php ENDPATH**/ ?>