    ...
    <div>
        <div class="accordion" id="accordionExample">
            <!-- <div class="card" v-for="category in categories" :key="category.id">
                ...
                <h2 class="mb-0">
                    <button class="btn btn-link" type="button" data-toggle="collapse" :data-target="category.id" aria-expanded="false" :aria-controls="category.id">
                    {{category.category}}
                    </button>
                </h2>
                </div>

                <div :id="category.id" class="collapse" :aria-labelledby="category.id" data-parent="#accordionExample">
                <div class="card-body">

                    <span v-for="cars in automotive" :key="cars.id">
                       <div class="custom-control custom-checkbox mb-14">
                            <input type="checkbox" class="custom-control-input" :id="cars.id">
